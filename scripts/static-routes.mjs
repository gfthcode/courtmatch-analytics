...
const routes = [
  ...
  ['player/compare', '球员对比 | CourtMatch', '比较两名 NBA 球员的双向直接对位和赛季效率。'],
  ['teams', '球队数据 | CourtMatch', '查看 NBA 球队目录、效率指标和当前发布数据覆盖。'],
  ['team', '球队散点 | CourtMatch', '查看 NBA 球队目录与当前发布数据覆盖。'],
  ['team/pk', '球队攻防 | CourtMatch', '查看 NBA 球队进攻、防守和节奏指标。'],
  ['team/compare', '球队对比 | CourtMatch', '并排比较两支 NBA 球队的已发布赛季指标。'],
  ['comparison', '双人球员比较 | CourtMatch', '比较两名 NBA 球员的双向直接对位、进攻效率与赛季趋势，导出对比数据与分享卡片。'],
  ['matchup', '联盟对位 | CourtMatch', '按球员、球队、赛季和最低回合筛选 NBA 直接对位。'],
  ...
  ['salary/compare', '薪资对比 | CourtMatch', '查看球员薪资对比数据接入状态。'],
  ['salary/team-compare', '球队薪资对比 | CourtMatch', '查看球队薪资对比数据接入状态。'],
  ['future', '未来展望 | CourtMatch', '查看 CourtMatch NBA 数据产品公开路线图。'],
  ['predict', '球员展望 | CourtMatch', '查看 CourtMatch NBA 数据产品公开路线图。'],
  ['predict/compare', '球员展望对比 | CourtMatch', '查看 CourtMatch NBA 数据产品公开路线图。'],
  ['predict/team-compare', '球队展望对比 | CourtMatch', '查看 CourtMatch NBA 数据产品公开路线图。'],
  ['impact', '攻防影响 | CourtMatch', '比较 NBA 球员进攻产出、防守压制与当前联盟基准。'],
  ['onoff', '攻防影响 | CourtMatch', '比较 NBA 球员进攻产出、防守压制与当前联盟基准。'],
  ['daily', '每日最佳 | CourtMatch', '查看最近一次可用 NBA 对位数据摘要。'],
  ['countries', '球员国家 | CourtMatch', '查看球员国家字段映射状态与未映射报告。'],
  ['country', '球员国家 | CourtMatch', '查看球员国家字段映射状态与未映射报告。'],
